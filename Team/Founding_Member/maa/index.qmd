...
about:
  ...
  links:
    ...
    - text: "{{< ai google-scholar >}}"
      href: https://scholar.google.com/citations?user=qNbuVDYAAAAJ&hl=en
      target: _blank
---

::: {#hero-heading}
<div style="text-align: justify;">
[Md Al Amin](https://www.facebook.com/alamin14114) is an undergraduate student of Biochemistry and Molecular Biology at [Jagannath University](https://jnu.ac.bd/department/portal/biochemistry), Bangladesh, with strong training in both experimental and computational biomedical research. He currently works as a Research Assistant at the [Red-Green Research Centre](), focusing on peptide-based drug design using computational biology approaches, while also contributing to departmental laboratory projects.
